  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="标题" prop="title">
        ...
        <el-form-item label="任务类型 1成长任务 2日常任务" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择任务类型 1成长任务 2日常任务" clearable size="small">
          <el-option label="请选择字典生成" value="" />
        </el-select>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="taskList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务类型 1成长任务 2日常任务" align="center" prop="type" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="规则" prop="delFlag">
          <el-input v-model="form.delFlag" placeholder="请输入规则" />
        </el-form-item>
        <el-form-item label="任务类型 1成长任务 2日常任务">
          <el-select v-model="form.type" placeholder="请选择任务类型 1成长任务 2日常任务">
            <el-option label="请选择字典生成" value="" />
          </el-select>
        </el-form-item>
      </el-form>
...
<script>
import { listTask, getTask, delTask, addTask, updateTask, exportTask } from "@/api/ab/task";
